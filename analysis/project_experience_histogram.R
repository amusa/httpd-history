...
hist(projectAnalysis$ProjCommits, breaks=20, col="red", main="Java Code Fix Churn Histogram", freq=TRUE, xlab="Lines of Java Code, Added+Deleted", labels=TRUE, axes=FALSE) 
axis(2) 
...
hist(projectAnalysisNonVCC$ProjCommits, breaks=10, col="blue", main="CVSS Severity", freq=TRUE, xlab="CVSS Score", labels=TRUE, axes=FALSE) 
axis(2) 
